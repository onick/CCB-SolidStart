-- Schema SEGURO para Centro Cultural Banreservas
-- Maneja casos donde elementos ya existen

-- 1. Eliminar triggers existentes si ya existen
...
-- 2. Eliminar función si ya existe
DROP FUNCTION IF EXISTS update_updated_at_column();

-- 3. Eliminar políticas existentes si ya existen
...
-- 9. Insertar eventos SOLO si la tabla está vacía
...
-- 10. Insertar administrador SOLO si no existe
...
-- ¡Schema aplicado de forma segura! 